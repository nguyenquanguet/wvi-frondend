...
class _TargetData extends State<InputMISData> {
  ...
  bool _boyVisitable = false;
  bool _girlVisitable = false;
  bool _maleVisitable = false;
  bool _femaleVisitable = false;
  bool _mvcVisitable = false;
  bool _rcVisitable = false;
  bool _d1Visitable = false;
  bool _d2Visitable = false;
  bool _d3Visitable = false;
  ...
  void findSelectFromIndicatorCode(String indicatorCode) {
    if (indicatorCode == "NU01") {
      setState(() {
        _maleVisitable = true;
        _femaleVisitable = true;
        _d1Visitable = true;
        _d2Visitable = true;
        _d3Visitable = true;
      });
    }
    else if (indicatorCode == "CE10" || indicatorCode == "CE11") {
      setState(() {
        _maleVisitable = true;
        _femaleVisitable = true;
      });
    }
    else if (indicatorCode == "NU02" || indicatorCode == "NU03" ||
        indicatorCode == "CE03" || indicatorCode == "CE04" ||
        indicatorCode == "CE05" || indicatorCode == "CE06" ||
        indicatorCode == "CE07" || indicatorCode == "CE08"){
      setState(() {
        _boyVisitable = true;
        _girlVisitable = true;
        _mvcVisitable = true;
    ...
    else if (indicatorCode == "NU05" || indicatorCode == "NU06" ||
        indicatorCode == "NU07" || indicatorCode == "NU08"){
      setState(() {
        _boyVisitable = false;
        _girlVisitable = false;
        _maleVisitable = false;
        _femaleVisitable = false;
        _mvcVisitable = false;
        _rcVisitable = false;
        _d1Visitable = false;
        _d2Visitable = false;
    ...
    else if (indicatorCode == "CE09" || indicatorCode == "CE12" ||
        indicatorCode == "CE13"){
      setState(() {
        _d2Visitable = true;
        _d3Visitable = true;
  ...
  void getIndicatorDescription(String indicatorCode) async {
    for (int i = 0; i < indicatorList.length; i++) {
      if (indicatorCode == indicatorList
          .elementAt(i)
          .code) {
        _selectIndicatorDesciption = indicatorList
            .elementAt(i)
            .description;
      }
    }
  ...
  void getVisitable(int unitId) async {
    switch (unitId) {
      case 1:
      case 2:
      case 3:
                              ...
                              onChanged: (String? newValue) {
                                setState(() {
                                  ...
                                  getIndicatorDescription(
                                      newValue.toString());
                                  setFalse();
                                  findSelectFromIndicatorCode(newValue!);
                                });
                              },
